set(NUTENS_LIB_LIST
    "-lnuTens -libtensor -libpropagator -libinstrumentation -libnt-logging -libconstants -libunits"
)
...
install(PROGRAMS "${PROJECT_BINARY_DIR}/nuTens-config" DESTINATION bin)
