...
This is ill advised, but if you're sure that's what you want to do you can set the option \n \
  -D NT_ALLOW_GLOBAL_PYTHON_ENV")
    ...
    execute_process(COMMAND ${Python_EXECUTABLE} -m pip install -r
                            ${PROJECT_SOURCE_DIR}/PyTorch_requirements.txt)

    # need to do some absolute tomfoolery to get the path to the torch shared
    # library
    execute_process(
      COMMAND ${Python_EXECUTABLE}
              ${PROJECT_SOURCE_DIR}/cmake/torch-cmake-prefix.py
  ...
  elseif(NT_TORCH_FROM_SCRATCH)
    ...
    cpmaddpackage(NAME Torch GIT_REPOSITORY git@github.com:pytorch/pytorch.git
                  VERSION 2.7.1)
...
# ==== spdlog ====
# must be AddPackage not FindPackage as it needs to be compiled as part of
# nuTens not externally
...
if(NT_ENABLE_BENCHMARKING)
  ...
  cpmaddpackage(GITHUB_REPOSITORY "google/benchmark" VERSION 1.8.5 OPTIONS
...
if(NT_ENABLE_PYTHON)
  ...
  cpmaddpackage(GITHUB_REPOSITORY "pybind/pybind11" VERSION 3.0.4)
