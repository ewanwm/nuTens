...
class ThreeFlavourBarger:
    ...
    def get_transition_matrix_element(self, energy: typing.SupportsFloat | typing.SupportsIndex, a: typing.SupportsInt | typing.SupportsIndex, b: typing.SupportsInt | typing.SupportsIndex) -> complex:
        ...
        """
    def set_antineutrino(self, antineutrino: bool) -> ThreeFlavourBarger:
        ...
    def set_baseline(self, baseline: typing.SupportsFloat | typing.SupportsIndex) -> ThreeFlavourBarger:
        ...
    def set_deltacp(self, deltacp: typing.SupportsFloat | typing.SupportsIndex) -> ThreeFlavourBarger:
        ...
    def set_density(self, density: typing.SupportsFloat | typing.SupportsIndex) -> ThreeFlavourBarger:
        ...
    def set_m1(self, m1: typing.SupportsFloat | typing.SupportsIndex) -> ThreeFlavourBarger:
        ...
    def set_m2(self, m2: typing.SupportsFloat | typing.SupportsIndex) -> ThreeFlavourBarger:
        ...
    def set_m3(self, m3: typing.SupportsFloat | typing.SupportsIndex) -> ThreeFlavourBarger:
        ...
    def set_theta12(self, theta12: typing.SupportsFloat | typing.SupportsIndex) -> ThreeFlavourBarger:
        ...
