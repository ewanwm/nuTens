...
{
  public:
    DummyMatterSolver(int nGenerations, bool antiNeutrino, dtypes::deviceType device = dtypes::kCPU, long batchSize = 1)
        : BaseMatterSolver(nGenerations, antiNeutrino, device, batchSize){};
